...
<body onload="show();">
  ...
  <div class="container-fluid">
    ...
    <div class="text-right my-3">
      <button class="btn btn-lg btn-primary" onclick="window.location.href='chinese.php'"><span>Explore</span><i class="fa fa-angle-right ml-2" id="down3" aria-hidden="true"></i></button>
    </div>
        </div>
    ...
    <div class="text-right my-3">
      <button class="btn btn-lg btn-primary" onclick="window.location.href = 'indian.php'"><span>Explore</span><i class="fa fa-angle-right ml-2" id="down3" aria-hidden="true"></i></button>
    </div>
        </div>
    ...
    <div class="text-right my-3">
      <button class="btn btn-lg btn-primary" onclick="window.location.href = 'mexican.php'"><span>Explore</span><i class="fa fa-angle-right ml-2" id="down3" aria-hidden="true"></i></button>
    </div>
        </div>
        <div class="breakfast my-5" data-aos="fade-right" data-aos-duration="1000">
    ...
    <div class="text-right my-3">
      <button class="btn btn-lg btn-primary" onclick="window.location.href = 'italian.php'"><span>Explore</span><i class="fa fa-angle-right ml-2" id="down3" aria-hidden="true"></i></button>
    </div>
        </div>
        <div class="breakfast my-5" data-aos="fade-left" data-aos-duration="1000">
    ...
    <div class="text-right my-3">
      <button class="btn btn-lg btn-primary" onclick="window.location.href = 'japanese.php'"><span>Explore</span><i class="fa fa-angle-right ml-2" id="down3" aria-hidden="true"></i></button>
    </div>
        </div>
        <div class="breakfast my-5" data-aos="fade-right" data-aos-duration="1000">
    ...
    <div class="text-right my-3">
      <button class="btn btn-lg btn-primary" onclick="window.location.href = 'american.php'"><span>Explore</span><i class="fa fa-angle-right ml-2" id="down3" aria-hidden="true"></i></button>
    </div>
        </div>
      </div>
