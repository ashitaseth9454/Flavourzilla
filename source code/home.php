    ...
    <div class="row mt-5">
      <div class="col-md-4">
        <div class="card shadow mx-auto" data-aos="fade-up" data-aos-duration="1000">
          <div class="inner">
            <img src="images/meal.jpg" class="img2" onclick="mealtime();">
          </div>
          <div class="card-body text-center">
            ...
            <button class="btn btn-primary btn-block" type="button" onclick="mealtime();">EXPLORE</button>
          </div>
        </div>        
      </div>
      <div class="col-md-4">
        <div class="card shadow mx-auto mt-md-0 mt-4" data-aos="fade-up" data-aos-duration="1000">
          <div class="inner">
            <img src="images/cuisine.jpeg" class="img2" onclick="window.location.href = 'cuisine.php'">
          </div>
          <div class="card-body text-center">
            <h5 class="card-title">CUISINE</h5>
            <p align="justify" class="card-text">Explore Recipes on the basis of Meal Timings i.e. Breakfast, Lunch, Dinner. Just have a look.</p>
            <button class="btn btn-primary btn-block" onclick="window.location.href = 'cuisine.php'">EXPLORE</button>
          </div>
        </div>        
      </div>
      <div class="col-md-4">
        <div class="card shadow mx-auto mt-md-0 mt-4" data-aos="fade-up" data-aos-duration="1000">
          <div class="inner">
            <img src="images/ingredient.jpeg" class="img2" onclick="window.location.href = 'ingredient.php'">
          </div>
          <div class="card-body text-center">
            <h5 class="card-title">INGREDIENTS</h5>
            <p align="justify" class="card-text">Explore Recipes on the basis of Meal Timings i.e. Breakfast, Lunch, Dinner. Just have a look.</p>
            <button class="btn btn-primary btn-block" type="button" onclick="window.location.href = 'ingredient.php'">EXPLORE</button>
          </div>
        </div>        
      </div>
    </div>
        ...
        <section class="links1 d-flex flex-sm-row flex-column justify-content-around">
          ...
          <section class="link3">
            ...
            <ul>
              ...
              <li><i class="fa fa-facebook-official"></i><a href="home.php">flavourzillaindia</a></li>
            </ul>
          </section>
        </section>
      </section>
