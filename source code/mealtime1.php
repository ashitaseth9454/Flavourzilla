...
<body onload="show();">
  ...
  <div class="container-fluid">
    ...
    <div class="text-right my-3">
      <button class="btn btn-lg btn-primary" onclick="window.location.href='breakfast1.php'"><span>Explore</span><i class="fa fa-angle-right ml-2" id="down3" aria-hidden="true"></i></button>
    </div>
        </div>
    ...
    <div class="text-right my-3">
      <button class="btn btn-lg btn-primary" onclick="window.location.href = 'lunch1.php'"><span>Explore</span><i class="fa fa-angle-right ml-2" id="down3" aria-hidden="true"></i></button>
    </div>
        </div>
    ...
    <div class="text-right my-3">
      <button class="btn btn-lg btn-primary" onclick="window.location.href = 'dinner1.php'"><span>Explore</span><i class="fa fa-angle-right ml-2" id="down3" aria-hidden="true"></i></button>
    </div>
        </div>
      </div>
