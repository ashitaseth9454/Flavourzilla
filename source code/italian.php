...
<body onload="show();">
  ...
  <div class="container-fluid">
    ...
    $query= "SELECT * FROM recipe WHERE category = 'Cuisine' and category1 = 'Italian' ORDER BY id ASC";
      ...
      while($row = mysqli_fetch_array($query1)){
        ...
        <div class="col-md-4 col-lg-4 col-sm-12 my-2 my-5">
            <div class="card card1" data-aos="fade-in">
              ...
              <div class="btn-group">
                <a style="text-decoration: none; display: block; width: 100%;" href="recipe1.php?choose=<?php echo $row['name'] ?>"><input type="submit" name="btn1" class="btn btn-warning btn-block" value="View Recipe"></a>
              </div>
            </div>
        </div>
      ...
      <section class="d-flex flex-md-row flex-column" style="border-bottom: 2px solid grey;">
        ...
        <section class="links1 d-flex flex-sm-row flex-column justify-content-around">
          <section class="link1">
            ...
            <ul>
              <li><a href="mealtime">Meal Timings</a></li>
