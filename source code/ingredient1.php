...
<body onload="show();">
  ...
  <div class="container-fluid">
    ...
    <div class="text-right my-3">
      <button class="btn btn-lg btn-primary" onclick="window.location.href='bread1.php'"><span>Explore</span><i class="fa fa-angle-right ml-2" id="down3" aria-hidden="true"></i></button>
    </div>
        </div>
    ...
    <div class="text-right my-3">
      <button class="btn btn-lg btn-primary" onclick="window.location.href = 'corn1.php'"><span>Explore</span><i class="fa fa-angle-right ml-2" id="down3" aria-hidden="true"></i></button>
    </div>
        </div>
    ...
    <div class="text-right my-3">
      <button class="btn btn-lg btn-primary" onclick="window.location.href = 'wheat1.php'"><span>Explore</span><i class="fa fa-angle-right ml-2" id="down3" aria-hidden="true"></i></button>
    </div>
        </div>
        <div class="breakfast my-5" data-aos="fade-right" data-aos-duration="1000">
    ...
    <div class="text-right my-3">
      <button class="btn btn-lg btn-primary" onclick="window.location.href = 'fruit1.php'"><span>Explore</span><i class="fa fa-angle-right ml-2" id="down3" aria-hidden="true"></i></button>
    </div>
        </div>
      </div>
