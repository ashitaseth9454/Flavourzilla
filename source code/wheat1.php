...
<body onload="show();">
  ...
  <div class="container-fluid">
    ...
    $query= "SELECT * FROM recipe WHERE category = 'Ingredient' and category1 = 'Wheat' ORDER BY id ASC";
      ...
      while($row = mysqli_fetch_array($query1)){
        ...
        <div class="col-md-4 col-lg-4 col-sm-12 my-2 my-5">
            <div class="card card1" data-aos="fade-in">
              ...
              <div class="btn-group">
                <a style="text-decoration: none; display: block; width: 100%;" href="recipe2final.php?choose=<?php echo $row['name'] ?>"><input type="submit" name="btn1" class="btn btn-warning btn-block" value="View Recipe"></a>
              </div>
            </div>
        </div>
