...
<body onload="show();">
  ...
  <div class="sideNav" id="mysideNav">
    ...
    <a href="mealtime1.php" class="a1"><i class="fa fa-home" aria-hidden="true"></i>&nbsp;Shop By Brands</a>
    <a href="cuisine1.php" class="a1"><i class="fa fa-home" aria-hidden="true"></i>&nbsp;Shop By Category</a>
    <a href="ingredient1.php" class="a1"><i class="fa fa-home" aria-hidden="true"></i>&nbsp;New Arrivals</a>
    <a href="addrecipe.php" class="a1"><i class="fa fa-first-order" aria-hidden="true"></i>&nbsp;Your Orders</a>
    
  </div>
  <nav class="navbar navbar-expand-md navbar-dark bg-dark sticky-top mb-sm-0 mb-3 nav1">
            ...
            if (mysqli_num_rows($query1)>0) {
              while($row= mysqli_fetch_array($query1)){
                ...
                <div class="m-5" id="content">
                  <p class="name1" id="name1" data-aos="fade-in" data-aos-duration="1000"><?php echo $row['name'] ?></p>
                  <p class="star" data-aos="fade-in" data-aos-duration="1000"><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;&nbsp;<span>(<?php echo $row['likes']; ?> Likes, <?php echo $row['dislikes']; ?> Dislikes)</span></p>
                  <p class="lead" style="border-bottom: 2px solid #dcdcdc; padding-bottom: 15px; margin-top: -10px;" data-aos="fade-in" data-aos-duration="1000">Shared By : <?php echo $row['uploadedby']; ?></p>
                  <img src="<?php echo $row['image'] ?>" class="d-block img-fluid" data-aos="fade-up" data-aos-duration="1000">
                  <strong class="d-block lead mt-4 mb-2" style="font-size: 1.7em;" data-aos="fade-in" data-aos-duration="1000">Required Ingredients :</strong>
                  <ul id="list" class="ingredients-list" data-aos="fade-left" data-aos-duration="1000">
                    <li class="mb-1" id="i1"><?php echo $row['ingredient1']; ?></li>
                    <li class="mb-1" id="i2"><?php echo $row['ingredient2']; ?></li>
                    <li class="mb-1" id="i3"><?php echo $row['ingredient3']; ?></li>
                    <li class="mb-1" id="i4"><?php echo $row['ingredient4']; ?></li>
                    <li class="mb-1" id="i5"><?php echo $row['ingredient5']; ?></li>
                    <li class="mb-1" id="i6"><?php echo $row['ingredient6']; ?></li>
                    <li class="mb-1" id="i7"><?php echo $row['ingredient7']; ?></li>
                    <li id="i8"><?php echo $row['ingredient8']; ?></li>
                  </ul>
                  <strong class="d-block lead mt-4 mb-2" style="font-size: 1.7em;" data-aos="fade-in" data-aos-duration="1000">Direction :</strong>
                  <ul class="direction-list" data-aos="fade-left" data-aos-duration="1000">
                    <li class="mb-3" id="s1"><?php echo $row['step1']; ?></li>
                    <li class="mb-3" id="s2"><?php echo $row['step2']; ?></li>
                    <li class="mb-3" id="s3"><?php echo $row['step3']; ?></li>
                    <li class="mb-3" id="s4"><?php echo $row['step4']; ?></li>
                    <li class="mb-3" id="s5"><?php echo $row['step5']; ?></li>
                    <li class="mb-3" id="s6"><?php echo $row['step6']; ?></li>
                    <li id="s7"><?php echo $row['step7']; ?></li>
                  </ul>
                  <center><iframe src="<?php echo $row['video'] ?>" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen data-aos="fade-down" data-aos-duration="1000"></iframe></center>
                  <div class="d-flex flex-row justify-content-between align-items-center my-5 px-md-5 px-0 like" data-aos="fade-in" data-aos-duration="1000">
                    <p><a href="" onclick=""><i class="fa fa-thumbs-up" aria-hidden="true"></i>&nbsp;<?php echo $row['likes'] ?></a>&nbsp;&nbsp;&nbsp;<a href=""><i class="fa fa-thumbs-down" aria-hidden="true"></i>&nbsp;<?php echo $row['dislikes'] ?></a></p>
                    <button class="btn btn-success" onclick="fun1();">Download Recipe<i class="fa fa-download ml-1" aria-hidden="true"></i></button>
                  </div>
                </div>
              ...
              <center><div class="jumbotron jumbo my-md-5 mt-5 box-shadow d-flex justify-content-center align-items-center" data-aos="flip-left" data-aos-duration="1000" data-aos-delay="300">
              <strong class="display-4 str1">Sorry! There is no Recipe like <b><?php echo $name; ?></b></strong>
            </div></center>
          </div>
              <?php
            }
  ...
  ingredient = [document.getElementById("i1").innerHTML,document.getElementById("i2").innerHTML,document.getElementById("i3").innerHTML,document.getElementById("i4").innerHTML,document.getElementById("i5").innerHTML,document.getElementById("i6").innerHTML,document.getElementById("i7").innerHTML,document.getElementById("i8").innerHTML],
    loremipsum = [document.getElementById("s1").innerHTML,document.getElementById("s2").innerHTML,document.getElementById("s3").innerHTML,document.getElementById("s4").innerHTML,document.getElementById("s5").innerHTML,document.getElementById("s6").innerHTML,document.getElementById("s7").innerHTML]

    doc.setFont(fonts)
    doc.setFontSize(30)
    doc.text('Name of Recipe : '+document.getElementById('name1').innerHTML, 0.7, verticalOffset+0.4)
    verticalOffset +=0.5+(0.1+(0.5 * 20 / 72))
    
    doc.setFont(fonts)
    doc.setFontSize(20)
    doc.text('Ingredients : ', 0.7, verticalOffset+0.4)
...
for (var i in ingredient) {
  if (fonts.hasOwnProperty(i)) {
    ...
    lines = doc.setFont(font)
          .setFontSize(size)
          .splitTextToSize((parseInt(i)+1)+". "+ingredient[i], 7)
    doc.text(0.7, 0.6+(verticalOffset + size / 72), lines)

    verticalOffset +=0.1+((lines.length + 0.5) * size / 72)
  }
}
doc.setFontSize(20)
doc.text(0.7,1.1+(verticalOffset + size / 72), "Direction :")
verticalOffset +=1.1+(0.1+(0.5 * 20 / 72))
for (var i in loremipsum) {
  ...
  if (fonts.hasOwnProperty(i)) {
    ...
    lines = doc.setFont(font)
          .setFontSize(size)
          .splitTextToSize((parseInt(i)+1)+". "+loremipsum[i], 7)
    doc.text(0.7, 0.2+(verticalOffset + size / 72), lines)

    verticalOffset += 0.2+((lines.length + 0.5) * size / 72)
  }
}
doc.save(document.getElementById('name1').innerHTML+".pdf");
    }
  </script>
</body>
</html>