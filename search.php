...
<body onload="show();">
          ...
          <?php
            ...
            if (mysqli_num_rows($query1)>0) {
              while($row= mysqli_fetch_array($query1)){
                ?>
                <div class="m-5">
                  <p class="name1" data-aos="fade-in" data-aos-duration="1000"><?php echo $row['name'] ?></p>
                  ...
                  <ul class="ingredients-list" data-aos="fade-left" data-aos-duration="1000">
                    <li class="mb-1"><?php echo $row['ingredient1']; ?></li>
                    <li class="mb-1"><?php echo $row['ingredient2']; ?></li>
                    <li class="mb-1"><?php echo $row['ingredient3']; ?></li>
                    <li class="mb-1"><?php echo $row['ingredient4']; ?></li>
                    <li class="mb-1"><?php echo $row['ingredient5']; ?></li>
                    <li class="mb-1"><?php echo $row['ingredient6']; ?></li>
                    <li class="mb-1"><?php echo $row['ingredient7']; ?></li>
                    <li><?php echo $row['ingredient8']; ?></li>
                  </ul>
                  ...
                  <ul class="direction-list" data-aos="fade-left" data-aos-duration="1000">
                    <li class="mb-3"><?php echo $row['step1']; ?></li>
                    <li class="mb-3"><?php echo $row['step2']; ?></li>
                    <li class="mb-3"><?php echo $row['step3']; ?></li>
                    <li class="mb-3"><?php echo $row['step4']; ?></li>
                    <li class="mb-3"><?php echo $row['step5']; ?></li>
                    <li class="mb-3"><?php echo $row['step6']; ?></li>
                    <li><?php echo $row['step7']; ?></li>
                  </ul>
                  ...
                  <div class="d-flex flex-row justify-content-between align-items-center my-5 px-md-5 px-0 like" data-aos="fade-in" data-aos-duration="1000">
                    <p><span onclick="fun1();"><i class="fa fa-thumbs-up" aria-hidden="true"></i>&nbsp;<?php echo $row['likes'] ?></span>&nbsp;&nbsp;&nbsp;<span onclick="fun1();"><i class="fa fa-thumbs-down" aria-hidden="true"></i>&nbsp;<?php echo $row['dislikes'] ?></span></p>
              ...
              ?>
              <center><div class="jumbotron jumbo my-md-5 mt-5 mr-4 box-shadow d-flex justify-content-center align-items-center" data-aos="flip-left" data-aos-duration="1000" data-aos-delay="300">
  ...
  <script>
    ...
    function fun1(){
      swal({
        title: 'Error!',
        text: 'Please Login/Register to use this Feature',
        icon: 'warning',
        button: 'Retry!',
      });
    }
