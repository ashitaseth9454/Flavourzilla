...
<body onload="show();">
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-md-9">
        <div class="breakfast mt-5" data-aos = "fade-left" data-aos-duration="1000">
          <p class="display-4 mt-4 mx-auto text-center breakfast1">Bread</p>
    ...
    <div class="text-right my-3">
      <button class="btn btn-lg btn-primary" onclick="window.location.href='bread.php'"><span>Explore</span><i class="fa fa-angle-right ml-2" id="down3" aria-hidden="true"></i></button>
    </div>
        </div>
        <div class="breakfast my-5" data-aos="fade-right" data-aos-duration="1000">
          <p class="display-4 mt-4 mx-auto text-center breakfast1">Corn</p>
    ...
    <div class="text-right my-3">
      <button class="btn btn-lg btn-primary" onclick="window.location.href = 'corn.php'"><span>Explore</span><i class="fa fa-angle-right ml-2" id="down3" aria-hidden="true"></i></button>
    </div>
        </div>
        <div class="breakfast my-5" data-aos="fade-left" data-aos-duration="1000">
          <p class="display-4 mt-4 mx-auto text-center breakfast1">Wheat</p>
    ...
    <div class="text-right my-3">
      <button class="btn btn-lg btn-primary" onclick="window.location.href = 'wheat.php'"><span>Explore</span><i class="fa fa-angle-right ml-2" id="down3" aria-hidden="true"></i></button>
    </div>
        </div>
        <div class="breakfast my-5" data-aos="fade-right" data-aos-duration="1000">
          <p class="display-4 mt-4 mx-auto text-center breakfast1">Fruits</p>
    ...
    <div class="text-right my-3">
      <button class="btn btn-lg btn-primary" onclick="window.location.href = 'fruit.php'"><span>Explore</span><i class="fa fa-angle-right ml-2" id="down3" aria-hidden="true"></i></button>
    </div>
        </div>
      </div>
      <div class="col-md-3 aside">
        ...
        <div class="div2 mt-4">
          ...
          <div class="list2 pl-2" id="list2">
            ...
            <a href="italian.php" class="d-block">Indian</a>
