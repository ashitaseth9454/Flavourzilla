...
<body onload="show();">
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-md-9">
        <div class="breakfast mt-5" data-aos = "fade-left" data-aos-duration="1000">
          <p class="display-4 mt-4 mx-auto text-center breakfast1">Chinese</p>
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="img1 img-fluid" src="images/chinese1.jpg" alt="Los Angeles">
                <img class="img1 img-fluid" src="images/chinese2.jpg" alt="Los Angeles">
                <img class="img1 img-fluid" src="images/chinese3.jpg" alt="Los Angeles">
                <img class="img1 img-fluid" src="images/chinese4.jpg" alt="Los Angeles">
            </div>
            <div class="carousel-item">
                <img class="img1 img-fluid" src="images/chinese5.jpg" alt="Chicago">
                <img class="img1 img-fluid" src="images/chinese6.jpg" alt="Chicago">
                <img class="img1 img-fluid" src="images/chinese7.jpg" alt="Chicago">
                <img class="img1 img-fluid" src="images/chinese8.jpg" alt="Chicago">
            </div>
        </div>
    ...
    <div class="text-right my-3">
      <button class="btn btn-lg btn-primary" onclick="window.location.href='chinese1.php'"><span>Explore</span><i class="fa fa-angle-right ml-2" id="down3" aria-hidden="true"></i></button>
    </div>
        </div>
        <div class="breakfast my-5" data-aos="fade-right" data-aos-duration="1000">
          <p class="display-4 mt-4 mx-auto text-center breakfast1">Indian</p>
    ...
    <div class="text-right my-3">
      <button class="btn btn-lg btn-primary" onclick="window.location.href = 'indian1.php'"><span>Explore</span><i class="fa fa-angle-right ml-2" id="down3" aria-hidden="true"></i></button>
    </div>
        </div>
        <div class="breakfast my-5" data-aos="fade-left" data-aos-duration="1000">
          <p class="display-4 mt-4 mx-auto text-center breakfast1">Mexican</p>
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="img1 img-fluid" src="images/mexican1.jpg" alt="Los Angeles">
                <img class="img1 img-fluid" src="images/mexican2.jpg" alt="Los Angeles">
                <img class="img1 img-fluid" src="images/mexican3.jpg" alt="Los Angeles">
                <img class="img1 img-fluid" src="images/mexican4.jpg" alt="Los Angeles">
            </div>
            <div class="carousel-item">
                <img class="img1 img-fluid" src="images/mexican5.jpg" alt="Chicago">
                <img class="img1 img-fluid" src="images/mexican6.jpg" alt="Chicago">
                <img class="img1 img-fluid" src="images/mexican7.jpg" alt="Chicago">
                <img class="img1 img-fluid" src="images/mexican8.jpg" alt="Chicago">
            </div>
        </div>
    ...
    <div class="text-right my-3">
      <button class="btn btn-lg btn-primary" onclick="window.location.href = 'mexican1.php'"><span>Explore</span><i class="fa fa-angle-right ml-2" id="down3" aria-hidden="true"></i></button>
    </div>
        </div>
        <div class="breakfast my-5" data-aos="fade-right" data-aos-duration="1000">
          <p class="display-4 mt-4 mx-auto text-center breakfast1">Italian</p>
          <div id="demo4" class="carousel slide mx-auto mt-3" data-ride="carousel">
        <ul class="carousel-indicators">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="img1 img-fluid" src="images/italian1.jpg" alt="Los Angeles">
                <img class="img1 img-fluid" src="images/italian2.jpg" alt="Los Angeles">
                <img class="img1 img-fluid" src="images/italian3.jpg" alt="Los Angeles">
                <img class="img1 img-fluid" src="images/italian4.jpg" alt="Los Angeles">
            </div>
            <div class="carousel-item">
                <img class="img1 img-fluid" src="images/italian5.jpg" alt="Chicago">
                <img class="img1 img-fluid" src="images/italian6.jpg" alt="Chicago">
                <img class="img1 img-fluid" src="images/italian7.jpg" alt="Chicago">
                <img class="img1 img-fluid" src="images/italian8.jpg" alt="Chicago">
            </div>
        </div>
    ...
    <div class="text-right my-3">
      <button class="btn btn-lg btn-primary" onclick="window.location.href = 'italian1.php'"><span>Explore</span><i class="fa fa-angle-right ml-2" id="down3" aria-hidden="true"></i></button>
    </div>
        </div>
        <div class="breakfast my-5" data-aos="fade-left" data-aos-duration="1000">
          <p class="display-4 mt-4 mx-auto text-center breakfast1">Japanese</p>
          <div id="demo5" class="carousel slide mx-auto mt-3" data-ride="carousel">
        <ul class="carousel-indicators">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="img1 img-fluid" src="images/japanese.jpg" alt="Los Angeles">
                <img class="img1 img-fluid" src="images/japanese2.jpeg" alt="Los Angeles">
                <img class="img1 img-fluid" src="images/japanese3.jpg" alt="Los Angeles">
                <img class="img1 img-fluid" src="images/japanese4.jpg" alt="Los Angeles">
            </div>
            <div class="carousel-item">
                <img class="img1 img-fluid" src="images/japanese5.jpg" alt="Chicago">
                <img class="img1 img-fluid" src="images/japanese6.jpeg" alt="Chicago">
                <img class="img1 img-fluid" src="images/japanese7.jpg" alt="Chicago">
                <img class="img1 img-fluid" src="images/japanese8.jpg" alt="Chicago">
            </div>
        </div>
    ...
    <div class="text-right my-3">
      <button class="btn btn-lg btn-primary" onclick="window.location.href = 'japanese1.php'"><span>Explore</span><i class="fa fa-angle-right ml-2" id="down3" aria-hidden="true"></i></button>
    </div>
        </div>
        <div class="breakfast my-5" data-aos="fade-right" data-aos-duration="1000">
          <p class="display-4 mt-4 mx-auto text-center breakfast1">American</p>
          <div id="demo6" class="carousel slide mx-auto mt-3" data-ride="carousel">
        <ul class="carousel-indicators">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="img1 img-fluid" src="images/american1.jpg" alt="Los Angeles">
                <img class="img1 img-fluid" src="images/american2.jpg" alt="Los Angeles">
                <img class="img1 img-fluid" src="images/american3.jpg" alt="Los Angeles">
                <img class="img1 img-fluid" src="images/american4.jpg" alt="Los Angeles">
            </div>
            <div class="carousel-item">
                <img class="img1 img-fluid" src="images/american5.jpg" alt="Chicago">
                <img class="img1 img-fluid" src="images/american6.jpg" alt="Chicago">
                <img class="img1 img-fluid" src="images/american7.jpg" alt="Chicago">
                <img class="img1 img-fluid" src="images/american8.jpg" alt="Chicago">
            </div>
        </div>
    ...
    <div class="text-right my-3">
      <button class="btn btn-lg btn-primary" onclick="window.location.href = 'american1.php'"><span>Explore</span><i class="fa fa-angle-right ml-2" id="down3" aria-hidden="true"></i></button>
    </div>
        </div>
      </div>
